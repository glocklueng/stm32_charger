...
INT16U VirtAddVarTab[NumbOfVar] = {Adjust_batt0_vol_addr, Adjust_batt1_vol_addr, Adjust_batt0_cur_addr,Adjust_batt1_cur_addr,batt0_capacity_addr,batt1_capacity_addr,
                                   LED_Mode, LCD_Light_Mode, Laguage, LCD_contrast, LCD_show_mode, Eeprom_Flag};

/* Private function prototypes -----------------------------------------------*/
/* Private functions ---------------------------------------------------------*/
static FLASH_Status EE_Format(void);
static INT16U EE_FindValidPage(u8 Operation);
